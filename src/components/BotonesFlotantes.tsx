...
export const BotonesFlotantes: React.FC = () => {
  ...
  const [mostrarWhApp, setmostrarWhApp] = useState(false);
  ...
  return (
    <div className="fixed bottom-6 right-6 flex flex-col items-end gap-4 z-50">
      ...
      <div className="relative flex flex-col items-end">
        {mostrarIg && (
          <div className="absolute bottom-16 right-0 bg-white shadow-xl rounded-lg p-3 mb-2 flex flex-col gap-2 w-48 border border-gray-200">
            <a href="https://www.instagram.com/masterdelcastillo_1/" target="_blank" className="text-sm font-semibold hover:text-red-600">📸 Javier Del Castillo</a>
            <a href="https://www.instagram.com/silver_facu/" target="_blank" className="text-sm font-semibold hover:text-red-600">📸 Facundo Silveira</a>
          </div>
        )}
        <button 
      ...
      <div className="relative flex flex-col items-end">
        ...
        > Salinas</a>
            <a 
        href="https://wa.me/59893470924" 
        target="_blank" 
        rel="noopener noreferrer"
        className="bg-red-500 text-white p-4 rounded-full shadow-lg hover:scale-110 transition-transform flex items-center justify-center"
        > GOES</a>
          </div>
        )}
        <button 
          onClick={() => setmostrarWhApp(!mostrarWhApp)}
